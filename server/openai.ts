...
export async function generateChatResponse(
  ...
  const inventoryContext = cars.map((car) => 
...
10. When comparing vehicles, focus on the most relevant differences for the customer's needs`;
  ...
  return response.choices[0].message.content || "I apologize, but I couldn't generate a response. Could you please try again?";
}
